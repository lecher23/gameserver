...
#define INSTALL_SBINDIR "/opt/mysql/server-5.7/sbin"
#define INSTALL_BINDIR "/opt/mysql/server-5.7/bin"
#define INSTALL_MYSQLSHAREDIR "/opt/mysql/server-5.7/share/mysql"
#define INSTALL_SHAREDIR "/opt/mysql/server-5.7/share"
#define INSTALL_PLUGINDIR "/opt/mysql/server-5.7/lib/mysql/plugin"
#define INSTALL_INCLUDEDIR "/opt/mysql/server-5.7/include/mysql"
#define INSTALL_SCRIPTDIR "/opt/mysql/server-5.7/bin"
#define INSTALL_MYSQLDATADIR "/opt/mysql/server-5.7//var/lib/mysql"
#define INSTALL_MYSQLKEYRINGDIR "/opt/mysql/server-5.7//var/lib/mysql-keyring"
/* #undef INSTALL_PLUGINTESTDIR */
#define INSTALL_INFODIR "/opt/mysql/server-5.7/share/mysql/docs"
#define INSTALL_MYSQLTESTDIR "/opt/mysql/server-5.7/lib/mysql-test"
#define INSTALL_DOCREADMEDIR "/opt/mysql/server-5.7/share/mysql"
#define INSTALL_DOCDIR "/opt/mysql/server-5.7/share/mysql/docs"
#define INSTALL_MANDIR "/opt/mysql/server-5.7/share/man"
#define INSTALL_SUPPORTFILESDIR "/opt/mysql/server-5.7/share/mysql"
#define INSTALL_LIBDIR "/opt/mysql/server-5.7/lib/x86_64-linux-gnu"
...
#define PACKAGE_STRING "MySQL Server 5.7.13"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "5.7.13"
#define VERSION "5.7.13"
