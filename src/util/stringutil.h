...
class StringUtil
{
 ...
 public:
    ...
    static void ArrayToStr(int32_t ary[], size_t len, const char seq, std::string &out);
    static void StrToIntArrayWithDefault
	(const char *src, const char seq, int32_t *dest, size_t count, int32_t defaulVal);
    static void StrToIntArrayWithDefault
	(const char *src, int len, const char seq, int32_t *dest, size_t count, int32_t defaultVal);

    static void StrToIntArray
